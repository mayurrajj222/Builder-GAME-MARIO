...
export const LEVELS: GameLevel[] = [
  ...
  // Level 2: Floating Gardens (Longer and Easier)
  {
    ...
    platforms: [
      ...
      // Slower moving platforms for easier gameplay with better spacing
      {
      ...
      // Static platform for rest - closer spacing
      {
      ...
      // Stepping stone platforms to bridge gaps
      {
      ...
      // Additional moving platforms with better positioning
      {
  ...
  // Level 4: Sky High
  {
    ...
    platforms: [
      ...
      // Add stepping stone before final platform
      {
        position: { x: 1000, y: 350 },
        velocity: { x: 0, y: 0 },
        size: { width: 120, height: 25 },
